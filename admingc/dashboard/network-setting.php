...
<div class="col-12">
    ...
    <div class="box-header with-border d-flex align-items-center justify-content-between">
        ...
        <?php foreach($data AS $network): if($network->network == $_GET["network"]): ?>
                ...
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Corporate2</label>
                    <div class="">
                        <select name="corporate2" class="form-control" required="required">
                        <?php if($network->corporate2Status == "On"): ?>
                            <option value="On" selected>Enable</option>
                            <option value="Off">Disable</option>
                        <?php else: ?>
                            <option value="On">Enable</option>
...
<div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                    <label for="success" class="control-label"><?php echo $_GET["network"]; ?> Corporate2 ID</label>
                    <div class="">
                        <input type="number" name="corporate2Id" value="<?php echo $network->corporate2Id; ?>" class="form-control" placeholder="SME ID" required />
                    </div>
                </div>
