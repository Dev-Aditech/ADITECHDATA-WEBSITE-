<header class="main-header">
    ...
    <link rel="icon" href="/assets/img/goocr.png" type="image/x-icon"> <!-- Favicon -->
    <title>User Account Deletion Policy - GooCredit</title>
	  ...
	  <div class="p-10 clearfix float-left">
		...
		<a href="dashboard" class="logo">
		  <!-- logo  -->
		  <span class="logo-lg">
			  <img src="/assets/img/gc.png" alt="logo" class="dark-logo" width="100">
		  </span>
		</a>	  
	  </div>
    <!-- Header Navbar -->
