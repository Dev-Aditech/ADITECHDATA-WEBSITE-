...
<div id="page">
    ...
    <div id="agent-upgrade-modal" 
        ...
        <div class="content">
            ...
            Check Pricing and get discounts available for Agents. 
            <br/> Upgrade with ₦<?php echo (is_object($data3)) ? $data3->agentupgrade : "0"; ?> for this service. 
    ...
    <div id="vendor-upgrade-modal" 
        ...
        <div class="content">
            ...
            Check Pricing and get discounts available for API Vendors. 
            <br/> Upgrade with ₦<?php echo (is_object($data3)) ? $data3->vendorupgrade : "0"; ?> for this service. 
            ...
            <div class="row mb-0">
                <div class="col-12">
                    <div class="input-style input-style-always-active has-borders mb-4">
                        <input type="password" name="kpin" maxlength="4" class="form-control" placeholder="12345" required>
                        <label for="form1" class="color-highlight">Transaction Pin</label>
                    </div>
                </div>
            </div>
