...
<style>
    body{background-image:url("../../assets/img/bgg.png");  background-repeat: no-repeat; background-size: cover; height: 130vh;}
...
$("document").ready(function(){
    ...
    $('#reg-form').submit(function(e){
            ...
            if($("#transpin").val().length != 6){$msg="Please enter a 6 digit pin";}
