...
<style>
    ...
    .card{background: rgba(255,255,255,0.0); margin:20px;}
    ...
    <div class="card card-style" style="min-width:450px; padding:20px;">
            <div class="content">
                ...
                <div class="text-center">
                    ...
                    <b>WARNING:</b> Please Ensure information provided on creating GooCredit account are correct and genuine to avoid <br> <b>"Account Blocking"</b>.
                    </p>
                ...
                <div class="px-2">
                    ...
                    <div class="input-style  no-borders has-icon mb-4">
                        ...
                        <input type="number" class="form-control" id="phone" name="phone" placeholder="Active Phone" required readonly />
                    ...
                    <div class="input-style  no-borders has-icon mb-4">
                        <i class="fa fa-at"></i>
                        <input type="email" class="form-control" id="email" name="email" placeholder="Email: example@gmail.com" readonly />
                    ...
                    <div class="input-style  no-borders has-icon mb-4">
                        <i class="fa fa-key"></i>
                        <input type="number" class="form-control" id="transpin" name="transpin" placeholder="Enter PIN - eg: 54710" required />
                    ...
                    <div class="col-12 text-center font-15 mt-3">
                        <a class="text-white" href="https://youtube.com/playlist?list=PLrSufz5-r5Y8_-0a08aY4IQuTNRkvVufb&si=ufYVX0LkB0LQO2si"><b>New to GooCredit?</b> • Watch Video Tutorials</a>
                    </div>
