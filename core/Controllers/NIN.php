    ...
    class NIN extends ApiAccess{
		...
		public function verifyMyNIN($body,$networkDetails){
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                "Authorization: Bearer lv_aspget_4bt718j11664kgmc75rnxe3u5svfqa99"
            ),
            ));
            ...
            if($result->status==true || $result->status=='success'){
              ...
              $conn = mysqli_connect("localhost","quickjot_updatedv7","quickjot_updatedv7","quickjot_updatedv7"); 
                ...
                $uslip = "https://quickjot.com.ng/slips/nin/{$slip}/?reportID=".$body->ref."&preview=1";
                $data = '
                {
                    "filepath":"'.$uslip.'",
                    "pagesize":"A4",
                ...
                if($respJ->convertedFilePath){
                    ...
                    curl_close ($ch);
                    fclose($fp);
                    $pdfURL = "https://quickjot.com.ng/slips/nin/{$slip}/".$pdfName;
