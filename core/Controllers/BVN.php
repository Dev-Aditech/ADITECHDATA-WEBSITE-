    ...
    class BVN extends ApiAccess{
		...
		public function verifyMyBVN($body,$networkDetails){
            ...
            if($result->status==true || $result->status=='success'){
                ...
                $conn = mysqli_connect("localhost","vtutelec_haske","vtutelec_haske","vtutelec_haske");   
                ...
                $uslip = "https://specialsubdata.com.ng/slips/bvn/?reportID=".$body->ref."&preview=1";
                $data = '
                {
                    "filepath":"'.$uslip.'",
                    "pagesize":"A4",
                ...
                if($respJ->convertedFilePath){
                    ...
                    curl_close ($ch);
                    fclose($fp);
                    $pdfURL = "https://specialsubdata.com.ng/slips/bvn/".$pdfName;
