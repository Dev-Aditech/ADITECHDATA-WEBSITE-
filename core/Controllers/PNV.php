    ...
    class PNV extends ApiAccess{
		...
		public function verifyMyPNV($body,$networkDetails){
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                "Authorization: Bearer lv_aspget_"
            ),
            ));
            ...
            if($result->status==true || $result->status=='success'){
                ...
                $uslip = "https://vtutelecom.ng/slips/nin/{$slip}/?reportID=".$body->ref."&preview=1";
                $data = '
                {
                    "filepath":"'.$uslip.'",
                    "pagesize":"A4",
                ...
                if($respJ->convertedFilePath){
                    ...
                    curl_close ($ch);
                    fclose($fp);
                    $pdfURL = "https://haskelinks.com.ng/slips/nin/{$slip}/".$pdfName;
